...
def push_to_github():
    ...
    # Get the local repository path from the input field and expand ~ to the user's home directory
    repo_dir = os.path.expanduser(repo_path_entry.get())
...
# Set the window icon (replace 'icon.ico' with the path to your icon file)
icon_path = 'icon.png'
